            ...
            <div className="container mx-auto max-w-7xl px-6">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-24 gap-12">
                    ...
                    <div className="max-w-sm space-y-8">
                        ...
                        <Link to="/works" className="group inline-flex items-center gap-6 text-[11px] font-black uppercase tracking-[0.4em] text-primary hover:text-accent transition-colors duration-300">
                            <span>{t("viewAll")}</span>
                            <div className="w-12 h-12 rounded-full border border-border flex items-center justify-center group-hover:border-accent group-hover:bg-accent group-hover:text-white transition-colors duration-300 shadow-sm">
                                <ArrowRight size={16} />
                            </div>
                        </Link>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-6 auto-rows-[280px]">
                    {collections.map((item, i) => (
                        <div
                            key={item.id}
                            className={cn(
                                "group relative overflow-hidden rounded-[4rem] bg-surface-muted border border-border/40 shadow-sm hover:shadow-premium transition-all duration-500",
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-cover bg-center transition-transform duration-[1.5s] group-hover:scale-105"
                                style={{ backgroundImage: `url('${item.img}')` }} />

                            {/* Artistic Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-primary/95 via-primary/30 to-transparent opacity-90 transition-opacity duration-300" />
